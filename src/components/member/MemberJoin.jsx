...
export default function MemberJoin() {
  ...
  const checkMemberId = useCallback(async () => {
    ...
    if (!valid) {
      ...
      setMemberIdFeedback(
        "아이디는 영문 소문자로 시작하며 숫자를 포함한 5-20자로 작성하세요"
      );
      return;
    }
  ...
  const checkMemberAddress = useCallback(() => {
    ...
    const empty =
      post.length === 0 && address1.length === 0 && address2.length === 0;
  ...
  const checkMemberContact = useCallback((e) => {
    ...
    setMemberClass((prev) => ({
      ...prev,
      contact: valid ? "is-valid" : "is-invalid",
    }));
  ...
  return (
    <>
      ...
      <div className="member-container mx-auto mt-5 p-4">
        ...
        <div className="row mt-4">
          ...
          <div className="col-sm-9">
            <input
              ...
              className={`form-control ${memberClass.pw}`}
              name="pw"
              value={member.pw}
              onChange={changeStrValue}
        ...
        <div className="row mt-4">
          ...
          <div className="col-sm-9">
            <input
              type={showPassword ? "text" : "password"}
              className={`form-control ${memberClass.pw2}`}
              name="pw2"
              value={member.pw2}
              onChange={changeStrValue}
              onBlur={checkMemberPw}
        ...
        <div className="row mt-4">
          ...
          <div className="col-sm-9">
            <input
              type="text"
              className={`form-control ${memberClass.name}`}
              name="name"
              value={member.name}
              onChange={changeStrValue}
              onBlur={() => {
        ...
        <div className="row mt-4">
          ...
          <div className="col-sm-9">
            <input
              type="text"
              className={`form-control ${memberClass.nickname}`}
              name="nickname"
          ...
          <div className="col-sm-9">
            <div className={`input-group ${memberClass.email}`}>
              ...
              <button
                ...
                disabled={
                  sending === true || memberClass.email === "is-invalid"
                }
              >
                {sending === true ? (
            ...
            >
              ...
              <Modal.Body className="d-flex justify-content-center">
                <DatePicker
                  selected={
                    member.birth
                      ? parse(member.birth, "yyyy-MM-dd", new Date())
                      : null
                  }
      ...
      >
        ...
        <Modal.Body>
          {memberDuplicateFeedback ||
            "입력하신 정보로 가입된 계정이 이미 있습니다."}
        </Modal.Body>
        <Modal.Footer>
          <Button
            variant="secondary"
      ...
      <div className="row">
        <div className="col text-center">
          <button
            ...
            disabled={memberValid === false || isDuplicatePassed === false}
            onClick={sendData}
          >
