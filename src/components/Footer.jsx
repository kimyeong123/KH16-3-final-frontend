                ...
                <div className="row">
                    ...
                    <div className="col-md-7 mb-3 text-start">
                        ...
                        <p className="footer-text small mt-2">
                            ...
                            <br /><br /><br />
                            Copyright© 1999, kobayauction, Inc All rights reserved.
                        </p>
                    </div>
                    ...
                    <div className="col-md-5 mb-3 text-start">
                        ...
                        <ul className="list-unstyled">
                            <li><a href="/faq" className="footer-text text-decoration-none d-block py-1"><i className="fa-regular fa-circle-question me-3"></i>문의하기</a></li>
                            <li><a href="https://pf.kakao.com/_xkxdxf" target="_blank" rel="noopener noreferrer" className="footer-text text-decoration-none d-block py-1"><i className="fa-brands fa-kakao-talk me-3"></i>카카오톡 상담</a></li>
                            <li><a href="#" className="footer-text text-decoration-none d-block py-1">
                                <i className="fa-regular fa-clipboard me-2"></i> 홈페이지 이용약관
                            </a></li>
                            <li><a href="#" className="footer-text text-decoration-none d-block py-1">
