...
export default function Header() {
  ...
  const filteredNotifications = notifications.filter((notif) => {
    ...
    if (activeTab === "personal")
      return notif.type === "GENERAL" || notif.type === "SELLER_QNA";
    return false;
  });
  ...
  return (
    ...
    >
      <div className="container-fluid py-1 d-flex justify-content-between align-items-center">
        {/* 1. 로고 영역 */}
        <Link
          className="navbar-brand fw-bold fs-4 d-flex align-items-center ms-2"
          to="/"
        >
          <img
            src={logo2}
        ...
        <div className="d-none d-lg-flex align-items-center fs-6 me-2">
          ...
          <div
            ref={dropdownRef}
            className={isLogin ? "dropdown me-5" : "dropdown me-5 text-muted"}
          >
            ...
            >
              ...
              <div className="d-flex border-bottom text-center">
                <div
                  className={`py-2 flex-fill cursor-pointer ${
                    activeTab === "all"
                ...
                >
                  중요 (
                  {
                    notifications.filter((n) => n.type === "SYSTEM_ALERT")
                      .length
                  }
                  )
                </div>
                ...
                >
                  개인 (
                  {
                    notifications.filter(
                      (n) => n.type === "GENERAL" || n.type === "SELLER_QNA"
                    ).length
                  }
                  )
                </div>
                  ...
                  filteredNotifications.map((notif) => (
                    ...
                    >
                      ...
                      <small className="text-muted ms-4">
                        발송:{" "}
                        {new Date(notif.sentTime).toLocaleTimeString("ko-KR", {
                          hour: "2-digit",
                          minute: "2-digit",
                        })}
                      </small>
          ...
          {isLogin ? (
            <div className="d-flex align-items-center">
              ...
              {/* 관리자일 때만 표시 */}
              {loginRole === "ADMIN" && (
                <span className="badge bg-danger me-3">관리자</span>
              )}
            ...
            <div className="d-flex align-items-center">
              ...
              <Link
                className="text-dark text-decoration-none"
                to="/etc/signupagree?next=/member/join"
              >
                회원가입
              </Link>
            </div>
